...
import './PopUpTouristsCard.css'
import {swapeChoosenChildCard,swapeChoosenAdultCard,boolPopUpTouristsCard} from '../../store/travelSlice'
export default function PopUpTouristsCard() {
    ...
    const dis=useAppDispatch()
        ...
        function choosePeople(){
          ...
          dis(swapeChoosenAdultCard(counterAdult))
          dis(swapeChoosenChildCard(counterChildren))

         dis(boolPopUpTouristsCard(false))
  ...
  return (
    <>
        ...
        <div className="pick-up-area__sub-people pick-up-area__sub-people--top">
                ...
                <div className="pick-up-area__sub-up">
                        <div className="pick-up-area__sub-up-container">
                            ...
                            <img className='pick-up-area__sub-up-exit-img' onClick={()=>dis(boolPopUpTouristsCard(false))} src={exit} alt="" />
                            </div>
